...
function space::checkforwincondition(%this)
{
...
space.healthdisplay(0,%player1.health);
}
...
space.healthdisplay(1,%player2.health);
}
}
...
$schedule_wincondition.schedulehandle=schedule(1000,0,"space::checkforwincondition");
}
