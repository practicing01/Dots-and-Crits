//change DeusExTelum to your module name
...
function DeusExTelum::checkforwincondition(%this)
{
...
$schedule_wincondition.schedulehandle=schedule(1000,0,"DeusExTelum::checkforwincondition",%this);
}
