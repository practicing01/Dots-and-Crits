function DeusExTelum::generatenpcs(%this)
{
...
if (!%this.simset_ass_npctiles.getCount()){return;}
...
%this.livemechcount=%simset_randomtileasses.getCount();

if (isObject(gui_text_livemechcount))
{
gui_text_livemechcount.setText(%this.livemechcount);
}
