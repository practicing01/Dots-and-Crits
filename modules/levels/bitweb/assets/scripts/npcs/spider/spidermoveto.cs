function class_bitspider::spidermoveto(%this,%position)
{
...
%this.ismoving=true;
%this.curdir=3;
%this.playAnimation("bitweb:anim_spider_run_right");
}
...
%this.ismoving=true;
%this.curdir=2;
%this.playAnimation("bitweb:anim_spider_run_left");
}
...
%this.ismoving=true;
%this.curdir=0;
%this.playAnimation("bitweb:anim_spider_run_up");
}
...
%this.ismoving=true;
%this.curdir=1;
%this.playAnimation("bitweb:anim_spider_run_down");
}
