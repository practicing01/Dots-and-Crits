function Ayn::setmenuiconvisible(%this)
{
...
%ass=AssetDatabase.acquireAsset("Ayn:image_menuicon");
...
$player1menuiconsprite.playAnimation("Ayn:anim_menuicon");
}
else//player 2
{
...
$player2menuiconsprite.playAnimation("Ayn:anim_menuicon");
}
