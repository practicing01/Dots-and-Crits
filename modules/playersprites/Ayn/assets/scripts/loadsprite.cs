...
if ($view==0)
{
%ass=AssetDatabase.acquireAsset("Ayn:image_topdown");
...
%player.sprite.setSpriteImage("Ayn:image_topdown",0);
%player.sprite.SetSpriteDepth(1);

AssetDatabase.releaseAsset(%ass.getAssetId());

%player.anim_stand_up="Ayn:anim_topdownstandup";
%player.anim_stand_down="Ayn:anim_topdownstanddown";
%player.anim_stand_left="Ayn:anim_topdownstandleft";
%player.anim_stand_right="Ayn:anim_topdownstandright";
%player.anim_run_up="Ayn:anim_topdownrunup";
%player.anim_run_down="Ayn:anim_topdownrundown";
%player.anim_run_left="Ayn:anim_topdownrunleft";
%player.anim_run_right="Ayn:anim_topdownrunright";
...
{
anim="Ayn:anim_topdownstanddown";
...
%ass=AssetDatabase.acquireAsset("Ayn:image_sideview");
...
%player.sprite.setSpriteLocalPosition(0,0);
%player.sprite.setSpriteSize(ScaleAssSizeVectorToCam(%ass));
%player.sprite.setSpriteImage("Ayn:image_sideview",0);
%player.sprite.SetSpriteDepth(1);

AssetDatabase.releaseAsset(%ass.getAssetId());

%player.anim_stand_up="Ayn:anim_sideviewstandup";
%player.anim_stand_down="Ayn:anim_sideviewstanddown";
%player.anim_stand_left="Ayn:anim_sideviewstandleft";
%player.anim_stand_right="Ayn:anim_sideviewstandright";
%player.anim_run_up="Ayn:anim_sideviewrunup";
%player.anim_run_down="Ayn:anim_sideviewrundown";
%player.anim_run_left="Ayn:anim_sideviewrunleft";
%player.anim_run_right="Ayn:anim_sideviewrunright";
%player.linear_damping=1;
