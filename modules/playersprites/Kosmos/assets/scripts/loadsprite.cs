function Kosmos::loadsprite(%this)
{
%this.loadass();
...
if ($view==0)
{
%ass=AssetDatabase.acquireAsset("Kosmos:image_topdown");
...
%player.sprite.setSpriteImage("Kosmos:image_topdown",0);
%player.sprite.SetSpriteDepth(1);

AssetDatabase.releaseAsset(%ass.getAssetId());

%player.anim_stand_up="Kosmos:anim_topdownstandup";
%player.anim_stand_down="Kosmos:anim_topdownstanddown";
%player.anim_stand_left="Kosmos:anim_topdownstandleft";
%player.anim_stand_right="Kosmos:anim_topdownstandright";
%player.anim_run_up="Kosmos:anim_topdownrunup";
%player.anim_run_down="Kosmos:anim_topdownrundown";
%player.anim_run_left="Kosmos:anim_topdownrunleft";
%player.anim_run_right="Kosmos:anim_topdownrunright";
...
{
anim="Kosmos:anim_topdownstanddown";
...
%ass=AssetDatabase.acquireAsset("Kosmos:image_sideview");
...
%player.sprite.setSpriteLocalPosition(0,0);
%player.sprite.setSpriteSize(ScaleAssSizeVectorToCam(%ass));
%player.sprite.setSpriteImage("Kosmos:image_sideview",0);
%player.sprite.SetSpriteDepth(1);

AssetDatabase.releaseAsset(%ass.getAssetId());

%player.anim_stand_up="Kosmos:anim_sideviewstandup";
%player.anim_stand_down="Kosmos:anim_sideviewstanddown";
%player.anim_stand_left="Kosmos:anim_sideviewstandleft";
%player.anim_stand_right="Kosmos:anim_sideviewstandright";
%player.anim_run_up="Kosmos:anim_sideviewrunup";
%player.anim_run_down="Kosmos:anim_sideviewrundown";
%player.anim_run_left="Kosmos:anim_sideviewrunleft";
%player.anim_run_right="Kosmos:anim_sideviewrunright";
%player.linear_damping=1;
...
%animobj=new ScriptObject()
{
anim="Kosmos:anim_sideviewstanddown";
