...
if ($view==0)
{
%ass=AssetDatabase.acquireAsset("Lelur:image_td_down_stand");//change Lelur to your module's name
...
//if you kept the same naming convention, change Lelur to your module's name
//if not, change the strings to match your animation asset's names
//the movement animations are required
%player.anim_stand_up="Lelur:anim_td_up_stand";
%player.anim_stand_down="Lelur:anim_td_down_stand";
%player.anim_stand_left="Lelur:anim_td_left_stand";
%player.anim_stand_right="Lelur:anim_td_right_stand";
%player.anim_run_up="Lelur:anim_td_up_run";
%player.anim_run_down="Lelur:anim_td_down_run";
%player.anim_run_left="Lelur:anim_td_left_run";
%player.anim_run_right="Lelur:anim_td_right_run";
...
{
anim="Lelur:anim_td_up_stand_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_down_stand_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_left_stand_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_right_stand_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_up_run_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_down_run_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_left_run_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_right_run_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_up_stand_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_down_stand_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_left_stand_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_right_stand_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_up_run_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_down_run_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_left_run_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_right_run_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_up_stand_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_down_stand_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_left_stand_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_right_stand_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_up_run_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_down_run_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_left_run_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_right_run_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_td_right_stand";
...
%ass=AssetDatabase.acquireAsset("Lelur:image_sv_down_stand");
...
%player.anim_stand_up="Lelur:anim_sv_up_stand";
%player.anim_stand_down="Lelur:anim_sv_down_stand";
%player.anim_stand_left="Lelur:anim_sv_left_stand";
%player.anim_stand_right="Lelur:anim_sv_right_stand";
%player.anim_run_up="Lelur:anim_sv_up_run";
%player.anim_run_down="Lelur:anim_sv_down_run";
%player.anim_run_left="Lelur:anim_sv_left_run";
%player.anim_run_right="Lelur:anim_sv_right_run";
%player.linear_damping=1;
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_up_stand_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_down_stand_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_left_stand_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_right_stand_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_up_run_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_down_run_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_left_run_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_right_run_selfcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_up_stand_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_down_stand_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_left_stand_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_right_stand_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_up_run_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_down_run_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_left_run_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_right_run_targetcast";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_up_stand_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_down_stand_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_left_stand_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_right_stand_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_up_run_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_down_run_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_left_run_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_right_run_melee";
...
%animobj=new ScriptObject()
{
anim="Lelur:anim_sv_right_stand";
