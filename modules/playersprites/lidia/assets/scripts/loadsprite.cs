function lidia::loadsprite(%this)
{
%this.loadass();
...
if ($view==0)
{
%ass=AssetDatabase.acquireAsset("lidia:image_topdown");
...
%player.sprite.setSpriteImage("lidia:image_topdown",0);
%player.sprite.SetSpriteDepth(1);

AssetDatabase.releaseAsset(%ass.getAssetId());

%player.anim_stand_up="lidia:anim_topdownstandup";
%player.anim_stand_down="lidia:anim_topdownstanddown";
%player.anim_stand_left="lidia:anim_topdownstandleft";
%player.anim_stand_right="lidia:anim_topdownstandright";
%player.anim_run_up="lidia:anim_topdownrunup";
%player.anim_run_down="lidia:anim_topdownrundown";
%player.anim_run_left="lidia:anim_topdownrunleft";
%player.anim_run_right="lidia:anim_topdownrunright";
...
{
anim="lidia:anim_topdownstanddown";
...
%ass=AssetDatabase.acquireAsset("lidia:image_sideview");
...
%player.sprite.setSpriteLocalPosition(0,0);
%player.sprite.setSpriteSize(ScaleAssSizeVectorToCam(%ass));
%player.sprite.setSpriteImage("lidia:image_sideview",0);
%player.sprite.SetSpriteDepth(1);

AssetDatabase.releaseAsset(%ass.getAssetId());

%player.anim_stand_up="lidia:anim_sideviewstandup";
%player.anim_stand_down="lidia:anim_sideviewstanddown";
%player.anim_stand_left="lidia:anim_sideviewstandleft";
%player.anim_stand_right="lidia:anim_sideviewstandright";
%player.anim_run_up="lidia:anim_sideviewrunup";
%player.anim_run_down="lidia:anim_sideviewrundown";
%player.anim_run_left="lidia:anim_sideviewrunleft";
%player.anim_run_right="lidia:anim_sideviewrunright";
%player.linear_damping=1;
...
%animobj=new ScriptObject()
{
anim="lidia:anim_sideviewstanddown";
animname="anim_topdownstanddown";
};
%player.anim_stand_up_selfcast.add(%animobj);
