...
%ass=AssetDatabase.acquireAsset("lidia:image_menuicon");
...
$player1menuiconsprite.playAnimation("lidia:anim_menuicon");
}
else//player 2
{
...
$player2menuiconsprite.playAnimation("lidia:anim_menuicon");
}
