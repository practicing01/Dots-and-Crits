...
%ass=AssetDatabase.acquireAsset("intrepid:image_menuicon");
...
$player1menuiconsprite.playAnimation("intrepid:anim_menuicon");
}
else//player 2
{
...
$player2menuiconsprite.playAnimation("intrepid:anim_menuicon");
}
